...
$$W = \frac{\left( \sum_{i=1}^{10} a_i d_{(i)} \right)^2}{\sum_{i=1}^{10}(d_i - \bar{d})^2} = 0.920154$$

**P-value Computation**

The p-value is computed from the distribution of the Shapiro–Wilk statistic under the null hypothesis of normality:

$$p = P(W \leq 0.920154 \mid H_0: \text{data is normal}, N = 10)$$
...
$$W = \frac{\left( \sum_{i=1}^{10} a_i d_{(i)} \right)^2}{\sum_{i=1}^{10}(d_i - \bar{d})^2} = 0.913566$$

**P-value Computation**

The p-value is computed from the distribution of the Shapiro–Wilk statistic under the null hypothesis of normality:

$$p = P(W \leq 0.913566 \mid H_0: \text{data is normal}, N = 10)$$
...
$$W = \frac{\left( \sum_{i=1}^{10} a_i d_{(i)} \right)^2}{\sum_{i=1}^{10}(d_i - \bar{d})^2} = 0.906393$$

**P-value Computation**

The p-value is computed from the distribution of the Shapiro–Wilk statistic under the null hypothesis of normality:

$$p = P(W \leq 0.906393 \mid H_0: \text{data is normal}, N = 10)$$
