...
Usage Examples:
    ...
    python preprocessing/continuous/cut_inactive_isolated.py data/processed/FSL105_val/clip_00001_good_morning_S0.npz
    
    # Process entire folder (overwrites all NPZ files in folder and updates CSV)
    python preprocessing/continuous/cut_inactive_isolated.py data/processed/FSL105_val/
    
    # Specify CSV file explicitly
    python preprocessing/continuous/cut_inactive_isolated.py data/processed/FSL105_val/ --csv-file data/processed/FSL105_val.csv
    
    # Adjust visibility threshold (higher = more lenient, lower = more strict)
    python preprocessing/continuous/cut_inactive_isolated.py input.npz --min-visible-ratio 0.2
    
    # Process folder with custom threshold
    python preprocessing/continuous/cut_inactive_isolated.py data/processed/FSL105_val/ --min-visible-ratio 0.2
    
    # Use minimum keypoint count instead of ratio
    python preprocessing/continuous/cut_inactive_isolated.py input.npz --min-visible-keypoints 10
"""
