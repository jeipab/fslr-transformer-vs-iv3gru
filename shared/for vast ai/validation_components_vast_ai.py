...
from ..components.ctc_case_utils import (
                    ...
                    if pred:
                        ...
                        with video_col:
                            if npz_data_for_preview:
                                try:
                                    import os
                                    # Import from visualization module in the same package
                        ...
                        st.markdown("---")
                        # Build TP/FP/FN case maps for coloring
                        ...
                        # Show legend for TP/FP/FN colors
                        render_case_legend()
