...
def create_keypoint_animation_video(keypoints_2d: np.ndarray, mask: Optional[np.ndarray], 
    ...
    frames_dir = os.path.join(tempfile.gettempdir(), f"frames_{key_suffix}")
    os.makedirs(frames_dir, exist_ok=True)
    
    # Define skeleton connections (from original function)
    skeleton_connections = {
        "pose": [
            (11, 12), (11, 13), (12, 14), (13, 15), (14, 16),
            (15, 17), (15, 19), (15, 21), (17, 19),
    ...
    if bg_type == "Original Video" and key_suffix in st.session_state.get('original_file_data', {}):
        try:
            ...
            if video_data:
                ...
                st.warning("No original video data found. Using default background.")
                bg_type = "White"
